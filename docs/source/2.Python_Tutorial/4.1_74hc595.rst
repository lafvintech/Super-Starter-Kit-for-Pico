...
.. note::
    ...
    * Open the ``4.1_74hc595.py`` file under the path of ``Super-Starter-Kit-for-Pico\Python\1.Project`` or copy this code into Thonny, then click "Run Current Script" or simply press F5 to run it.
...
Phenomenon
^^^^^^^^^^^
.. image:: img/5.phenomenon/4.1.mp4
    :width: 100%