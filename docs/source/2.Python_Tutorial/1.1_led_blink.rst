...
.. note::
    ...
    * Open the ``1.1_led_blink2.py`` file under the path of ``Super-Starter-Kit-for-Pico\Python\1.Project`` or copy this code into Thonny, then click "Run Current Script" or simply press F5 to run it.
...
Phenomenon
^^^^^^^^^^^
.. video:: img/5.phenomenon/1.1.mp4
    :width: 100%